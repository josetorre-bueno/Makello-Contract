// contract_tool_app_v0.1.4.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.1.4 — 2026-04-19
//
// Changes from v0.1.3:
//  - Site photo: file upload widget with thumbnail preview (jpg/png/webp)
//  - Image injected as Exhibit B page into the rendered docx via PizZip XML
//    (docxtemplater-image-module-free has no browser CDN build; pure PizZip approach used)
//  - a: and pic: namespaces declared inline on injected XML elements
//  - Image scaled to max 6" wide, aspect-ratio preserved
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.1.4</span>
