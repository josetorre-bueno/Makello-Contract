// contract_tool_app_v0.1.6.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.1.6 — 2026-04-19
//
// Changes from v0.1.5:
//  - Diagnostic panel: unpacks docxtemplater Multi error into individual messages
//  - Shows each error's id, message, and context (offset / tag name)
//  - Also logs full error object to console for deeper inspection
//  - Diagnostic panel clears on next generation attempt
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.1.6</span>
