// contract_tool_app_v0.1.7.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.1.7 — 2026-04-19
//
// Changes from v0.1.6:
//  - Export CSV now includes the site_photo row with the loaded filename as
//    the value (was silently excluded before); image data cannot go in a CSV
//    but the filename is useful as a record of which photo was used
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.1.7</span>
