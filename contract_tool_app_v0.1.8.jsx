// contract_tool_app_v0.1.8.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.1.8 — 2026-04-19
//
// Changes from v0.1.7:
//  - Fix root cause of "duplicate_open_tag" Multi error: docxtemplater
//    defaults to single-brace delimiters ({tag}) but the template uses
//    double-brace syntax ({{tag}}).  Added delimiters:{start:'{{',end:'}}'}
//    to the Docxtemplater constructor so it parses the template correctly.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.1.8</span>
