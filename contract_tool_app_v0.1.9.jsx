// contract_tool_app_v0.1.9.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.1.9 — 2026-04-19
//
// Changes from v0.1.8:
//  - Remove paragraphLoop:true from Docxtemplater constructor.  That option
//    modifies Word paragraph XML for loop sections; this template has no
//    array loops, so it was a no-op at best and was causing Word to warn
//    "unreadable content" on open (Word recovered fine, but the warning
//    was alarming).  linebreaks:true and delimiters are kept.
  ...
  async function generateContract() {
    ...
    try {
      ...
      const doc = new window.docxtemplater(zip, {
        ...
        // paragraphLoop not used: template has no {#array} loops
      });
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.1.9</span>
