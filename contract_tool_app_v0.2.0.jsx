// contract_tool_app_v0.2.0.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.2.0 — 2026-04-19
//
// Changes from v0.1.9:
//  - Fix "Word found unreadable content / Styles 1" repair warning: switch
//    both ZIP generate calls from type:'blob' to type:'uint8array' + Blob
//    constructor.  PizZip's direct blob output produces a ZIP that Word's
//    validator flags; the uint8array path is what docxtemplater docs
//    recommend for browser use and produces a clean file.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.2.0</span>
