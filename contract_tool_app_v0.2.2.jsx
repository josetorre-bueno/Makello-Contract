// contract_tool_app_v0.2.2.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.2.2 — 2026-04-19
//
// Changes from v0.2.1:
//  - Photo widget: when a CSV is re-imported that contains a saved photo
//    filename, display that filename as a reminder ("Last used: foo.jpg —
//    upload to include").  The photo can't round-trip through a CSV (browser
//    security) but showing the name tells the user which file to re-upload.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.2.2</span>
