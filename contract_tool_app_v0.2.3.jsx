// contract_tool_app_v0.2.3.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.2.3 — 2026-04-19
//
// Changes from v0.2.2:
//  - Fix Word "Styles 1" repair warning for real: instead of letting
//    docxtemplater/PizZip regenerate the entire ZIP (which recompresses
//    all 16 embedded .odttf font files and other binary parts, producing
//    a ZIP Word's validator dislikes), we now:
//      1. Keep the raw template ArrayBuffer in memory
//      2. Run docxtemplater on a separate PizZip copy just to render
//      3. Pull only the modified word/document.xml out of that copy
//      4. Patch it into a fresh PizZip opened from the original buffer
//      5. Remove comments, fix rels/content-types, then generate
//    Every file except document.xml is byte-for-byte from the original
//    template, so fonts, styles, numbering etc. are untouched.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.2.3</span>
