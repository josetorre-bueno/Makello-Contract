// contract_tool_app_v0.2.4.jsx
// Wipomo Contract Tool — Center for Community Energy
// v0.2.4 — 2026-04-19
//
// Changes from v0.2.3:
//  - Fix comment-reference stripping: previous regex required the run to
//    contain ONLY the commentReference, but runs also have <w:rPr> children
//    so none matched.  Now removes <w:commentReference .../> elements
//    directly regardless of run contents.
//  - Fix missing JPEG content type: addPhotoToDocx adds word/media/sitePhoto.jpg
//    but never registered a content type for it in [Content_Types].xml.
//    OOXML requires every part to have a registered content type; missing
//    entry is what Word flags as "unreadable content" when a photo is present.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.55 }}>Center for Community Energy · v0.2.4</span>
