// contract_tool_app_v0.2.5.jsx
// Makello Contract Tool
// v0.2.5 — 2026-04-19
//
// Changes from v0.2.4:
//  - Rename to "Makello Contract Tool" (remove CCE branding from header)
//  - Help panel: ? button in header toggles a full-width guide covering
//    the input CSV format, contractor defaults file, and site photo
//  - Export CSV and Save Defaults now use the File System Access API
//    (showSaveFilePicker) so the user can choose the save location;
//    falls back to FileSaver saveAs on browsers that don't support it
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.2.5</span>
          ...
          <div style={{ maxWidth: 1100, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 24 }}>
            ...
            <div>
              ...
              <p style={{ margin: '6px 0 0', fontSize: 12, color: '#744210', lineHeight: 1.5 }}>
                <strong>Site photo</strong> cannot be stored in a CSV. The filename is saved as a reminder; the photo must be re-uploaded each session.
              </p>
            </div>
