// contract_tool_app_v0.2.6.jsx
// Makello Contract Tool
// v0.2.6 — 2026-04-19
//
// Changes from v0.2.5:
//  - Pre-flight validation: before starting the document build, check that
//    all required fields are non-empty.  Legitimately optional fields are
//    excluded: customer_title (blank for sole proprietor), site_photo,
//    customer_tax_status_other (only required when tax status is "Other").
//    Missing fields are shown in the diagnostic panel with an amber header
//    so the user can see exactly what needs filling before retrying.
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.2.6</span>
