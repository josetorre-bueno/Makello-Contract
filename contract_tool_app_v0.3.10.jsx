// contract_tool_app_v0.3.10.jsx
// Makello Contract Tool (Beta)
// v0.3.10 — 2026-05-11
//
// Changes from v0.3.9:
//  - Help panel: added Field Highlighting paragraph explaining yellow highlight and Clean Copy switch.
//
// Changes from v0.3.5:
...
// Safe to call even if the template already has unrelated footers —
// uses a unique relationship ID (rIdPgFt1) that won't collide.
function addPageNumbersToZip(zip) {
  ...
  rels = rels.replace('</Relationships>',
    `<Relationship Id="${RID}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/footer" Target="footer1.xml"/></Relationships>`);
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.3.10</span>
