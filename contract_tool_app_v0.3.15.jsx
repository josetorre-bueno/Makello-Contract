    ...
    try {
      ...
      if (outputPdf) {
        ...
        const styledHtml = `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>
          ...
          td,th{border:1px solid #000;padding:3pt 5pt;}</style></head>
          <body>${html}</body></html>`;
        await html2pdf().set({
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.3.15</span>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 12, alignItems: 'center' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: 6,
                          fontSize: 12, color: 'white', cursor: 'pointer',
                          opacity: generating ? 0.5 : 1 }}
                 title="Output as PDF instead of Word .docx (uses mammoth conversion — formatting may vary slightly)">
