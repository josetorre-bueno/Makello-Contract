      ...
      if (outputPdf) {
        ...
        const printHtml = `<!DOCTYPE html><html><head><meta charset="UTF-8">
          ...
          <style>
            ...
            * { box-sizing: border-box; }
            body { font-family: Arial, sans-serif; font-size: 11pt;
                   line-height: 1.4; margin: 0; padding: 0; color: #000; }
            p { margin: 0 0 6pt; orphans: 3; widows: 3; }
            h1 { font-size: 13pt; font-weight: bold; margin: 12pt 0 6pt; page-break-after: avoid; }
            h2 { font-size: 12pt; font-weight: bold; margin: 10pt 0 4pt; page-break-after: avoid; }
            h3 { font-size: 11pt; font-weight: bold; margin: 8pt 0 3pt;  page-break-after: avoid; }
          ...
          <script>
            ...
            // Normal-style paragraphs. Detect and restore the contract title:
            // a paragraph whose only child is <strong>, all-caps, > 40 chars.
        ...
        printWindow.focus();
        // Delay gives DOMContentLoaded script time to run before the dialog
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.3.17</span>
