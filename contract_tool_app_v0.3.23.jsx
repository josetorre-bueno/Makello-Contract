...
function isLegacyCsv(rows) {
  // Makello wide/horizontal export: all field names across row 0, all values
  // across row 1.  Old format: first col is 'owner_name'.  New format (current):
  // first col is 'project_type'.  Fallback: check for multiple known Makello
  // field names anywhere in row 0 in case the column order changes again.
