      ...
      {showHelp && (
        <div style={{ background: '#ebf8ff', borderBottom: '2px solid #bee3f8', padding: '16px 24px' }}>
          <div style={{ maxWidth: 1200, display: 'grid', gridTemplateColumns: '1.3fr 1fr 1fr 1fr', gap: 24 }}>
            ...
            {/* Col 1 — Input CSV */}
            <div>
              <div style={{ fontWeight: 700, fontSize: 13, color: '#2c5282', marginBottom: 6 }}>Input CSV — Two Formats Accepted</div>
              ...
              <div style={{ fontWeight: 600, fontSize: 12, color: '#2c5282', margin: '0 0 3px' }}>Format 2 — Sky-D proposal export (auto-detected)</div>
              <p style={{ margin: '0 0 4px', fontSize: 12, color: '#2d3748', lineHeight: 1.5 }}>
                The Sky-D proposal system exports a wide CSV: all ~100 field names across row 1, all values across row 2. The tool detects this format automatically (row 1 starts with <code style={{ background: '#e2e8f0', padding: '1px 3px', borderRadius: 3 }}>owner_name</code>) and maps the relevant fields:
              </p>
              <ul style={{ margin: '0 0 6px', paddingLeft: 16, fontSize: 12, color: '#2d3748', lineHeight: 1.6 }}>
              ...
              <p style={{ margin: '0 0 6px', fontSize: 12, color: '#744210', lineHeight: 1.5 }}>
                The remaining fields (dates, tax status, signatory) are not in the Sky-D export — fill them in manually after loading.
              </p>
              <p style={{ margin: 0, fontSize: 12, color: '#744210', lineHeight: 1.5 }}>
                <strong>Site photo</strong> — the filename is saved to the CSV as a reminder, but the photo must be re-uploaded each session (browsers do not allow web pages to re-read files from your disk without your permission).
              </p>
            </div>
