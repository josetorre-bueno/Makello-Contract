// contract_tool_app_v0.3.9.jsx
// Makello Contract Tool (Beta)
// v0.3.9 — 2026-05-11
//
// Changes from v0.3.8:
//  - Tool renamed to "Makello Contract Tool (Beta)".
//  - Output Word doc now includes page numbers (right-aligned footer).
//  - Filled fields highlighted light yellow in output for checker visibility.
//  - "Clean Copy" switch in header to output without highlighting.
//
// Changes from v0.3.5:
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.3.9</span>
