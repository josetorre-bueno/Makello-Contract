// contract_tool_app_v0.6.7.jsx
// Makello Contract Tool (Beta)
// v0.6.7 — 2026-05-28 23:52 PT
...
function App() {
  ...
  useEffect(() => {
    ...
    fetch('./contract_defaults.json?v=0.6.7')
  ...
  // pretending to work.
  useEffect(() => {
    fetch('./translation_defaults.csv?v=0.6.7')
  ...
  async function mergeAddendumInto(outputZip, mergeData) {
    const addResp = await fetch('./addendum_template.docx?v=0.6.7');
  ...
  async function generateContract(isDraft = false) {
    ...
    try {
      const templateFile = contractType === 'pv_battery'
        ? './Wipomo_Contract_Template_Battery.docx?v=0.6.7'
        : './Wipomo_Contract_Template.docx?v=0.6.7';
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ background: '#1a365d', color: 'white', padding: '10px 20px',
        ...
        <span style={{ fontSize: 11, opacity: 0.45 }}>v0.6.7</span>
